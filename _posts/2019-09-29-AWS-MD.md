...
mvn install
mvn clean package
java -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,aress=localhost:8000 -jar /Users/nimda/Documents/wordpress-amazon/litemall/litemall-all/target/litemall-all-0.1.0-exec.jar
```  
