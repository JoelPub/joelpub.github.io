...
```javascript
https://search.google.com/search-console/settings?resource_id=https%3A%2F%2Fwww.qcldigital.com%2F
tech.admin@qcldigital.com/B*************2***
DNS主机记录    记录类型    记录值
@     TXT google-site-verification=kVkb7_oLyFBXyD1-qfR1M7W7_pdQ2go7IM6grUTWb9c
https://ziyuan.baidu.com/dashboard/index?site=https://www.qcldigital.com/
qcl_digital/B***Z****2020
DNS主机记录    记录类型    记录值
