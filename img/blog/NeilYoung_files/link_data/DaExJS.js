 ...
 */
  ...
  */
  ...
  function showWebChat(objNo,status){
    ...
    _url = "https://irs.pacific.com.tw/wbc/check.php?fpc="+fpc+"&objNo="+objNo + "&auto=" + status;  
    if (_check_mobile) { 
      _mobile_v='mobile';
      //alert(_url);
  ...
  */
  ...
  var Mapping = {
    ...
    'aqM': {
      src: 'https://mapping.daexauto.com/link.php',
      key: 'aqM'
    },
    'aqE': {
  ...
  var beaconList = [{
    ...
    name: 'beaconSend',
    url: 'https://project-daex-azure-function-event-prd-01.azurewebsites.net/api/eventData',
    genData: function (env) {
    ...
    name: 'beaconJS_mapping_aq',
    url: 'https://asia-east2-accuhit-tw-project.cloudfunctions.net/fpcMappingAQ',
    genData: function (env) {
    ...
    name: 'beaconJS_mapping',
    url: 'https://asia-east2-accuhit-tw-project.cloudfunctions.net/fpcMapping',
    genData: function (env) {
      return function (f1, f2) {
        return {
          f1: env.fpc,
    ...
    name: 'beaconJS3',    
    url: 'https://project-daex-azure-function-tracker-prd-01.azurewebsites.net/api/TrackTrigger',
    genData: function (env) {
  ...
  var daex_pixel = function (env) {
    ...
    d.appendChild(e), (e.src = 'https://mapping.daexauto.com/daex_Pixel.php?tk='+env.fpc + '&fr=' + env.hostname);
  ...
  var domainMappings = {
    allRun: function (env) {
      ...
      daex_pixel(env)
      AD2_pixel(env)
      if (env.hostname != 'mapping.daexauto.com') {
  ...
  var hostIP = function (callback) {
    getR('json', '//api.accunix.net/magic/ping', function () {
